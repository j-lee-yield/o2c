...
export declare const routingLevels: readonly ["parent_account", "billing_account", "branch"];
...
export type ContactRole = "customer" | "collector" | "approver" | "internal" | "ap" | "shared_finance" | "treasury" | "branch" | "invoice";
...
export declare function defaultRoutingLevel(): RoutingLevel;
