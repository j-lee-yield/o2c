import type { CallOutcomePayload, CommunicationChannel, CommunicationProvider, EmailOutcomePayload, SmsOutcomePayload } from "./communications.js";
export type CommunicationProviderMaturity = "email_complete" | "sms_ready" | "voice_ready";
...
export interface CommunicationProviderInboundEnvelope<TPayload extends Record<string, unknown> = Record<string, unknown>> {
    channel: CommunicationChannel;
    provider: CommunicationProvider;
...
//# sourceMappingURL=communication-providers.d.ts.map