...
export type RemittanceSourceInput = EmailInboxRemittanceInput | UploadRemittanceInput | LinkedPaymentWorkflowRemittanceInput;
...
export interface RemittanceIngestionOutcome {
    remittanceId: string;
    state: "received_unparsed" | "parsed_structured" | "linked_to_payment" | "linked_to_invoice_candidate" | "review_required" | "resolved" | "orphaned";
